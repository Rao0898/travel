...
const Service2 = () => {
  return (
    <div className="relative w-full h-96 select-none"> {/* Adjust height here */}
          ...
          <div className="w-full lg:w-2/3">
            <div className="flex flex-col w-full py-16 px-6 lg:py-32 lg:px-8 bg-opacity-50 rounded-md">
              <div className="text-left w-full">
                ...
                <span className="font-bold italic" style={{ fontFamily: "'Playfair Display', serif" }}>Luxury Viator Services </span> 
                </h2>
