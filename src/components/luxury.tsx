        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-6xl text-6xl mb-4 font-medium text-gray-900">
              Why <span className="font-bold italic" > Luxury</span> 
              <br className="hidden lg:inline-block" />
              <span className="font-bold italic" > Viator?</span>  
            </h1>
            ...
            <div className="w-full lg:w-2/3">
              <div className="flex flex-col w-full py-16 px-6 lg:py-32 lg:px-8 bg-opacity-50 rounded-md">
                <div className="text-left w-full">
                  ...
                  <span className="font-bold italic" > Dream for your next memorable vacation? </span> 
                  </h2>
